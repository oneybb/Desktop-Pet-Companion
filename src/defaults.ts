...
export const DEFAULT_FOODS: FoodItem[] = [
  {
    ...
    statsBonus: { happiness: 4, energy: 15, cleanliness: 0 },
  },
  {
    id: 'ikan_bilis',
    name: 'Ikan Bilis',
    ...
    statsBonus: { happiness: 8, energy: 25, cleanliness: 0 },
  },
  {
    id: 'catnip',
    name: 'Catnip Herb',
    ...
    statsBonus: { happiness: 12, energy: 20, cleanliness: 0 },
  },
  {
    id: 'cream',
    name: 'Cream Bowl',
    ...
    statsBonus: { happiness: 6, energy: 8, cleanliness: 0 },
  },
];
